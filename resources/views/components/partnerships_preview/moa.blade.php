<?php 
        $memorandum = $partnership->memorandum;

        $combinedWhereasClausesForPdf = [];
        $partnerAcronym = $partnership->proposalForm->institution_name_acronym;
        foreach (json_decode($memorandum->whereas_clauses) as $index => $clauseData) {
            ...
            $whereasClauses = $combinedWhereasClausesForPdf;
        }
?>
...
<body>
    ...
    <div id="page1">
        <div class="page-center">
            ...
            <h2 class="text-center">{{strtoupper($partnership->proposalForm->institution_name)}} ({{strtoupper($partnership->proposalForm->country)}})</h2>
            <br><br><br>
    ...
    <div id="page2">
        ...
        <p class="indented-paragraph">
            <span class="bold"> {{ strtoupper($partnership->proposalForm->institution_name) }}
                ({{ $partnership->proposalForm->country }})</span>,
            {{ $partnership->proposalForm->institution_overview }} Herein represented by its {{$partnership->proposalForm->institution_head_title}},
            <span class="bold">
                {{ strtoupper($partnership->proposalForm->institution_head) }}</span>, (hereafter
            referred to as <span
                class="bold">"{{ $partnership->proposalform->institution_name_acronym }}"</span>).
        </p>
        ...
        @include('components.memorandum._witnessethSection2', ['link' => $partnership])
    </div>
    ...
    <div id="page4">
        ...
        <p class="numbered-paragraph">
            2.2. The {{$partnership->proposalForm->institution_name_acronym}} hereby represents and warrants that:
        </p>
    ...
    <div id="page7">
        <br>
        <h2 class="text-center"> ARTICLE 5<br>RESPONSIBILITIES OF {{$partnership->proposalForm->institution_name_acronym}} </h2>
    ...
    <div id="page8">
        <br>
        <h2 class="text-center"> ARTICLE 6<br>RESPONSIBILITIES OF AUF AND {{$partnership->proposalForm->institution_name_acronym}} </h2>
    ...
    @if (!empty($memorandum->article_10))
    ...
    <div id="page13">
        ...
        @if (!empty($memorandum->article_11))
    ...
    <div id="page14">
        ...
        @if (!empty($memorandum->article_12))
    ...
    <div id="page15">
        ...
        @if (!empty($memorandum->article_13))
    ...
    <div id="page16">
        ...
        @if (!empty($memorandum->article_14))
    ...
    <div id="page17">
        ...
        @if (!empty($memorandum->article_15))
    ...
    <div id="page18">
        ...
        @if (!empty($memorandum->article_16))
    ...
    <div id="page19">
        ...
        @if (!empty($memorandum->article_17))
    ...
    <div id="page20">
        ...
        @if (!empty($memorandum->article_18))
    ...
    @if (!empty($memorandum->article_19))
    ...
    <div id="page23">
        ...
        @if (!empty($memorandum->article_21))
    ...
    <div id="page24">
        <div style="page-break-after: always;"></div>
        @include('components.memorandum._lastPage',['link' => $partnership])
    </div>
