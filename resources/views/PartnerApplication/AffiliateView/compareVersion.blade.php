...
<h1 class="text-center"> You are viewing: Version {{$currentVersion}} </h1>

    <div class="biContainer">
        <div class="biContainer-area1">
            <div class="previewStyle">
                @include('components.documents_preview.moa_comparison', array_merge([
                    'document' => $document,
                    'partner_name' => $partner_name,
                    'contact_person' => $contact_person,
                    'contact_email' => $contact_email,
                    'whereasDiff' => $whereasDiff,
                    'diffArticle1' => $diffArticle1,
                    'diffArticle2' => $diffArticle2,
                    'diffArticle3' => $diffArticle3,
    ...
    <script>
        function back() {
                window.location.href = '{{ route('affiliateShowDocument', ["id"=>$document->id, "name"=>$document->proposalForm->institution_name]) }}';
        }
