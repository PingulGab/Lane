...
<form id="createNewAffiliate">
    ...
    <button type="button" id="createAffiliateBtn">Create</button>
</form>
...
<div id="linkModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Affiliate Created!</h2>
        <p>Affiliate Named: <strong> <span id="affiliateName"></span> </strong> been created.</p>
...
<script>
    ...
    var btn = document.getElementById('createAffiliateBtn');
    ...
    btn.onclick = function(event) {
        ...
        .then(data => {
            ...
            if (data.name && data.password) {
                ...
                document.getElementById('affiliateName').textContent = data.name;
