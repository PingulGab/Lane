@php
    ...
    // Check if whereas_clauses is a JSON string, then decode it
    $whereasClauses = is_string($memorandum->whereas_clauses)
        ? json_decode($memorandum->whereas_clauses, true)
        : $memorandum->whereas_clauses;
    $predefinedTags = [
        'the AUF',
        'AUF',
    ...
    // Check if $whereasClauses is an array and extract any custom tags
    if (is_array($whereasClauses)) {
        foreach ($whereasClauses as $clause) {
            if (is_array($clause) && isset($clause['dropdown']) && !in_array($clause['dropdown'], $allTags)) {
                // Add custom tag if it doesn't already exist in $allTags
            $allTags[] = $clause['dropdown'];
            }
        }
    }
...
@section('content')
            ...
            <div class="memorandum-form-container-area2">
                ...
                <div class="menu-container">
                    <div class="menu" id="article0Menu" style="display: none;">
                        <div class="form-group">
                            <label>Title:</label>
                            <input type="text" class="form-control" name="partnership_title" id="partnership_title"
                                placeholder="" required value="{{ $memorandum->partnership_title }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu" id="whereas-section-options" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex;">
                                <div id="tags-container" class="form-control" style="display: flex; min-height: 30px;">
                        ...
                        <div id="whereas-clauses-container">
                            ...
                            @foreach ($whereasClauses as $index => $clause)
                                <div class="form-group whereas-clause-item mt-2">
                                    <label>Whereas,</label>
                                    ...
                                    <select class="whereas-clause-select form-control" name="whereas_clauses[]">
                                        @foreach ($allTags as $tag)
                                            <option value="{{ $tag }}"
                                                {{ $clause['dropdown'] === $tag ? 'selected' : '' }}>{{ $tag }}
                                            </option>
                                        @endforeach
                                    </select>

                                    <!-- Textarea -->
                                    <textarea class="form-control" name="whereas_clause_texts[]" required>{{ $clause['text'] }}</textarea>

                                    <!-- Remove Clause Button -->
                                    <button type="button" class="btn btn-danger mt-2 remove-clause-btn">Remove</button>
                                </div>
                            @endforeach

                            <!-- Button to Add New Clause -->

                        </div>
                        <button type="button" class="btn btn-secondary mt-3" id="add-whereas-clause-btn">Add Another
                ...
                <div class="menu-container">
                    <div class="menu" id="article10Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article10-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article11Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article11-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article12Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article12-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article13Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article13-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article14Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article14-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article15Menu" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            <input type="number" class="form-control" id="durationInput" placeholder="Enter number"
                                min="1" value="{{ $validity }}" required>
                        </div>
                        <div class="form-group">
                            <label>Time Unit:</label>
                            <select class="form-control" id="timeUnitDropdown">
                                <option value="day" <?php if ($selectedTimeUnit === 'day') {
                                    echo 'selected';
                                } ?>>Day</option>
                                <option value="month" <?php if ($selectedTimeUnit === 'month') {
                                    echo 'selected';
                                } ?>>Month</option>
                                <option value="year" <?php if ($selectedTimeUnit === 'year') {
                                    echo 'selected';
                                } ?>>Year</option>
                            </select>
                        </div>
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article15-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article16Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article16-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article17Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article17-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article18Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article18-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article19Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article19-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article20Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article20-btn">Add Another
                            Entry</button>
                    </div>
                </div>
                ...
                <div class="menu-container">
                    <div class="menu" id="article21Menu" style="display: none;">
                        ...
                        <!-- Add New Clause Button -->
                        <button type="button" class="btn btn-secondary" id="add-article21-btn">Add Another
                            Entry</button>
                    </div>
                </div>
    </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const loadedTagsFromDB = @json($allTags);
            let isEditing = false;
            let debounceTimeout;
            let previousPartnerName = partnerNameInput.value; // Preload the initial partner name

            const defaultTags = loadedTagsFromDB;
            let userTags = loadedTagsFromDB;
            ...
            function updatePartnerNameTags(partnerName) {
                // Filter out previous partner name-related tags
                tags = defaultTags.filter(tag => !tag.includes(previousPartnerName));
            ...
            function addCustomTag(tagValue) {
                ...
                if (!tags.includes(tagValue) && !customTags.includes(tagValue)) {
                    customTags.push(tagValue); // Track custom tag
                    tags.push(tagValue); // Add to tags for rendering
            ...
            function removeTag(tag) {
                ...
                customTags = customTags.filter(t => t !== tag); // Remove from custom tags too
                renderTags(isEditing);
                updateDropdownOptions();
            }
            ...
            function updateDropdownOptions() {
                ...
                document.querySelectorAll('.whereas-clause-select').forEach(dropdown => {
                    ...
                    // Merge default tags with custom tags and populate options
                    ...
                    if (allTags.includes(selectedValue)) {
            ...
            // Event delegation to handle click on dynamically rendered "Remove" buttons
            whereasClausesContainer.addEventListener('click', function(event) {
                if (event.target.classList.contains('remove-clause-btn')) {
                    // Find the parent div with the class "whereas-clause-item" and remove it
                    const clauseItem = event.target.closest('.whereas-clause-item');
                    if (clauseItem) {
                        clauseItem.remove();

                        // Optional: Update the preview if necessary
            ...
            function setupArticleHandlers(articleNumber) {
                ...
                function updateArticlePreview() {
                    const articleItems = Array.from(containerElement.querySelectorAll(
                        `.article${articleNumber}Item`)).map((item, index) => {
